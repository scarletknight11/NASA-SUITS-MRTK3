...
IL_0029:
	{
		...
		NullCheck(L_7);
		bool L_9;
		L_9 = VirtualFuncInvoker1< bool, RuntimeObject* >::Invoke(115 /* System.Boolean System.Type::IsInstanceOfType(System.Object) */, L_7, L_8);
...
IL_0214:
	...
	}
	{
		...
		NullCheck(L_71);
		Type_t* L_72;
		L_72 = VirtualFuncInvoker0< Type_t* >::Invoke(117 /* System.Type System.Type::GetEnumUnderlyingType() */, L_71);
		V_30 = L_72;
...
IL_0053:
	{
		...
		L_15 = VirtualFuncInvoker0< TypeU5BU5D_t97234E1129B564EB38B8D85CAC2AD8B5B9522FFB* >::Invoke(114 /* System.Type[] System.Type::GetInterfaces() */, L_14);
		V_4 = L_15;
...
IL_0113:
	{
		...
		NullCheck(L_51);
		Type_t* L_52;
		L_52 = VirtualFuncInvoker0< Type_t* >::Invoke(112 /* System.Type System.Type::get_BaseType() */, L_51);
		___type0 = L_52;
